...
Usage:
  python3 04_baselines.py --project-dir /path/to/jgrapht
"""
...
def main():
    ...
    pit_files = discover_pit_files(REPO_ROOT, ["jgrapht/results/per-class/*/mutations.xml", "jgrapht/results/per-class/*/mutations.xml.gz"])
